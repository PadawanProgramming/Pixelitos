    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col lg:flex-row" id="pixelitos-root">
      ...
      <div className="flex-1 min-w-0 flex flex-col min-h-screen">
        ...
        <header className="h-16 bg-white border-b border-slate-200 px-4 sm:px-6 flex items-center justify-between shadow-3xs shrink-0">
          ...
          {/* Right Header Controls - Tutorial Button */}
          <div className="flex items-center gap-3">
            <button
              onClick={() => {
                setTutorialStep(0);
              ...
              className={`inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider bg-gradient-to-r from-[#f0da4c] to-amber-400 hover:from-yellow-300 hover:to-amber-300 text-slate-950 py-2 px-3.5 rounded-xl shadow-md transition-all active:scale-95 cursor-pointer font-sans border border-amber-300/60 ${
                isTutorialOpen ? 'ring-4 ring-amber-400 ring-offset-2 animate-pulse' : ''
              }`}
              title="Iniciar tutorial interactivo para profesores y coordinadoras"
            >
              <HelpCircle className="w-4 h-4 shrink-0 animate-bounce" />
              <span>Tutorial de la App</span>
              <span className="bg-slate-950 text-white text-[8px] font-black tracking-normal px-1.5 py-0.5 rounded ml-1 animate-pulse">GUÍA</span>
            </button>
          </div>
        </header>
